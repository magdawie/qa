...
public class WindowsTest extends ConfigFrontend{
  ...
  @Test
    public void testWindows() {
        ...
        String secondTestWindowHandle = null; // trzeba sleep dodac
        ...
        int hyperlinkElement = driver.findElement(By.linkText("Open page in a new window")).getLocation().getY();
        int hyperlinkYCoordinate = hyperlinkElement;
